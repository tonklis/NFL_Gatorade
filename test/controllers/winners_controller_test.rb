...
class WinnersControllerTest < ActionController::TestCase
  ...
  test "should create winner" do
    assert_difference('Winner.count') do
      post :create, winner: { code_id: @winner.code_id, prize_id: @winner.prize_id, user_id: @winner.user_id }
    end
  ...
  test "should update winner" do
    patch :update, id: @winner, winner: { code_id: @winner.code_id, prize_id: @winner.prize_id, user_id: @winner.user_id }
    assert_redirected_to winner_path(assigns(:winner))
  end

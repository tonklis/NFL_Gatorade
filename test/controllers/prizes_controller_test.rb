...
class PrizesControllerTest < ActionController::TestCase
  ...
  test "should create prize" do
    assert_difference('Prize.count') do
      post :create, prize: { description: @prize.description, difficulty_id: @prize.difficulty_id, stock: @prize.stock }
    end
  ...
  test "should update prize" do
    patch :update, id: @prize, prize: { description: @prize.description, difficulty_id: @prize.difficulty_id, stock: @prize.stock }
    assert_redirected_to prize_path(assigns(:prize))
  end
